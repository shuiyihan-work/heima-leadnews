...
CREATE TABLE `ad_channel`  (
  ...
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '频道信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of ad_channel
-- ----------------------------
INSERT INTO `ad_channel` VALUES (1, 'java', '全栈java', 1, 0, 2, '2019-08-16 10:55:31');
INSERT INTO `ad_channel` VALUES (2, 'mysql', '入门到精通', 1, 1, 2, '2019-08-16 10:55:35');
INSERT INTO `ad_channel` VALUES (3, 'vue', '火不火，自己感觉', 1, 0, 3, '2019-08-16 10:55:38');
INSERT INTO `ad_channel` VALUES (4, 'Python', '未来的语言', 1, 1, 4, '2019-08-16 10:55:41');
...
INSERT INTO `ad_channel` VALUES (34, 'PHP', '世界上最好的语言吗？', 1, 0, 0, '2020-03-21 14:08:54');
...
CREATE TABLE `ad_sensitive`  (
  ...
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3116 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '敏感词信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ad_sensitive` VALUES (3115, '77', '2020-03-16 21:49:32');
...
CREATE TABLE `ad_user`  (
  ...
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员用户信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of ad_user
-- ----------------------------
INSERT INTO `ad_user` VALUES (1, 'wukong', '123', NULL, 'mo', NULL, '13320325525', 1, 'wukong@qq.com', '2019-07-30 10:16:41', '2019-07-30 10:16:43');
INSERT INTO `ad_user` VALUES (2, 'admin', '34e20b52f5bd120db806e57e27f47ed0', '123456', 'ad', NULL, '13320325528', 1, 'admin@qq.com', '2020-03-04 17:07:37', '2020-03-04 17:07:40');
